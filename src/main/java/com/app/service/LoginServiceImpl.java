...
public class LoginServiceImpl implements LoginService {
	...
	public String logInIntoAccount(LoginDTO dto) throws LoginException {
		...
		Optional<CurrentUserSession> validCustomerSessionOpt = getCurrentUserSession(existingUser);
	...
	private Optional<CurrentUserSession> getCurrentUserSession(User existingUser) {
		Optional<CurrentUserSession> validCustomerSessionOpt =  sr.findById(existingUser.getUserLoginId());
		return validCustomerSessionOpt;
	}
